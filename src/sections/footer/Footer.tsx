    ...
    <footer className="w-full text-foreground relative z-10 border-t border-border-subtle flex flex-col md:flex-row mt-16 bg-background">
      ...
      <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-between min-h-[60vh]">
        ...
        <div className="flex gap-4 mt-16 mb-8">
          <a href="#" aria-label="Instagram" className="w-8 h-8 flex items-center justify-center border border-border-subtle rounded hover:bg-hover transition-colors">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
          </a>
          <a href="#" aria-label="LinkedIn" className="w-8 h-8 flex items-center justify-center border border-border-subtle rounded hover:bg-hover transition-colors">
